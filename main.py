...
class BlogPost(db.Model):
    ...
    comments = relationship("User", back_populates='blog')
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, form=form, logged_in=current_user.is_authenticated, comments=requested_post.comments)
